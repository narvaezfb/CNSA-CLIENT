...
import { Avatar, List, ListItem, ListItemAvatar, ListItemText, Typography, Grid, Menu, MenuItem, } from '@material-ui/core';
                ...
                <MainCard border={false} className={classes.card} contentClass={classes.content}>   
                    <Grid container direction="column">    
                        ...
                        <Grid item sx={{ mb: 1.25 }}>
                            <Typography className={classes.subHeading}>Total Recruitment Incidents</Typography>
                        </Grid>
                    </Grid>
                </MainCard>
            )}
