...
import legalImage from "../../../../assets/images/6101100.jpg";
  ...
  return (
    <>
      <Grid container spacing={gridSpacing}>
        <Grid item xs={12}>
        <Grid item xs={12}>
            <Typography align="center" variant="h1">Internal Support</Typography>
</Grid>
                  ...
                  <Card sx={{ minWidth:445}}>
                    <CardActionArea>
                      ...
                      <CardContent>
                        ...
                        <a href="https://www.freepik.com/vectors/business"><h4>Business vector created by jcomp - www.freepik.com</h4></a>
                          Privacy
                        </Typography>
                                ...
                                <div>
                                  ...
                                  <ul>
                                    ...
                                    <li>
                                      <p>
                                        ...
                                        "Our" in this Agreement) refers to CNSA,
                                        1 Toronto, L1F 054.
                                      </p>
                                    </li>
                                    <li>
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      Cookie is being sent. However, if You do
                                      not accept Cookies, You may not be able to
                                      use some parts of our Service. Unless you
                                      have adjusted Your browser setting so that
                                      it will refuse Cookies, our Service may
                                      use Cookies.
                                    </li>
                                    <li>
                                      <strong>Flash Cookies.</strong> Certain
                                      features of our Service may use local
                                      stored objects (or Flash Cookies) to
                                      collect and store information about Your
                                      preferences or Your activity on our
                                      Service. Flash Cookies are not managed by
                                      the same browser settings as those used
                                      for Browser Cookies. For more information
                                      on how You can delete Flash Cookies,
                                      please read "Where can I change the
                                    ...
                                    <li>
                                      ...
                                      web beacons (also referred to as clear
                                      gifs, pixel tags, and single-pixel gifs)
                                      that permit the Company, for example, to
                                      count users who have visited those pages
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      analyze the use of our Service, to contact
                                      You.
                                    </li>
                                    <li>
                                      <strong>For business transfers:</strong>{" "}
                                      ...
                                      of all or a portion of Our business to
                                      another company.
                                    </li>
                                    <li>
                                      ...
                                      venture partners or other companies that
                                      We control or that are under common
                                      control with Us.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <strong>With other users:</strong> when
                                      You share personal information or
                                      otherwise interact in the public areas
                                      with other users, such information may be
                ...
                <Grid item xs={6} >
                  <Card sx={{ minWidth: 445}}>
                    <CardActionArea>
                      ...
                      <CardContent>
                        <Typography gutterBottom variant="h5" component="div">
                          <a href="https://www.freepik.com/vectors/technology"> <h4>Technology vector created by stories - www.freepik.com</h4></a>
                          Terms and Conditions
                          
                        </Typography>
                        <Typography variant="body2" color="text.secondary">
                        These terms and conditions outline the rules
                                  and regulations for the use of CNSA's Website,
                                  located at www.cnsa.com.                                   By accessing this website we assume you accept
                            ...
                            <DialogContent dividers={scroll === "paper"}>
                              ...
                              >
                                ...
                                <p>
                                  ...
                                  person log on this website and compliant to
                                  ...
                                  stated services, in accordance with and
                                  subject to, prevailing law of Netherlands. Any
                                  use of the above terminology or other words in
                                  the singular, plural, capitalization and/or
                                  he/she or they, are taken as interchangeable
                                ...
                                <p>
                                  ...
                                  CNSA, you agreed to use cookies in agreement
                                  with the CNSA's Privacy Policy.{" "}
                                </p>

                                <p>
                                  Most interactive websites use cookies to let
                                  us retrieve the user’s details for each visit.
                                  Cookies are used by our website to enable the
                                  functionality of certain areas to make it
                                  easier for people visiting our website. Some
                                  of our affiliate/advertising partners may also
                                  use cookies.
                                </p>
                                ...
                                <p>
                                  ...
                                  website. Comments do not reflect the views and
                                  opinions of CNSA,its agents and/or affiliates.
                                  Comments reflect the views and opinions of the
                                  person who post their views and opinions. To
                                  the extent permitted by applicable laws, CNSA
                                  shall not be liable for the Comments or for
                                  any liability, damages or expenses caused
                                  and/or suffered as a result of any use of
                                  and/or posting of and/or appearance of the
                                  Comments on this website.
                                </p>

                                <p>
                                  CNSA reserves the right to monitor all
                                  Comments and to remove any Comments which can
                                  be considered inappropriate, offensive or
                                ...
                                <p>
                                  You hereby grant CNSA a non-exclusive license
                                  to use, reproduce, edit and authorize others
                                ...
                                <p>
                                  ...
                                  to publications or to other Website
                                  information so long as the link: (a) is not in
                                  any way deceptive; (b) does not falsely imply
                                  sponsorship, endorsement or approval of the
                                  linking party and its products and/or
                                ...
                                <p>
                                  ...
                                  would not make us look unfavorably to
                                  ourselves or to our accredited businesses; (b)
                                  the organization does not have any negative
                                  records with us; (c) the benefit to us from
                                  the visibility of the hyperlink compensates
                                  the absence of CNSA; and (d) the link is in
                                ...
                                <p>
                                  ...
                                  paragraph 2 above and are interested in
                                  linking to our website, you must inform us by
                                  sending an e-mail to CNSA. Please include your
                                ...
                                <p>
                                  ...
                                  that alter in any way the visual presentation
                                ...
                                <p>
                                  ...
                                  remove all links or any particular link to our
                                  Website. You approve to immediately remove all
                                  links to our Website upon request. We also
                                  reserve the right to amen these terms and
                                  conditions and it’s linking policy at any
